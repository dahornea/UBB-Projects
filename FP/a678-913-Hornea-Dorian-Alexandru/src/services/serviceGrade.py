...
class ServiceGrade:
    ...
    def first_statistic(self, id_ass):
        ...
        res.sort(key=lambda x: x.get_value_grade(), reverse=True)
        return res
    ...
    def second_statistic(self):
        ...
        list_of_assignments_passed_deadline = []
        ...
        for grade in grades:
            student_id = grade.get_id_stud_grade()
            if grade.get_id_ass_grade() in list_of_assignments_passed_deadline and grade.get_value_grade() == 0:
